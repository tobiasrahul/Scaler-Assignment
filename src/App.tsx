  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-50">
      <header className="sticky top-0 z-10 bg-white/80 backdrop-blur-sm h-16 flex justify-between items-center border-b shadow-sm px-4">
        <h2 className="text-xl font-semibold text-blue-600">LearnHub</h2>
        <Authenticated>
          <SignOutButton />
        </Authenticated>
      </header>
    ...
    <div className="h-full">
      <Unauthenticated>
        <div className="min-h-screen flex">
          ...
          <div className="w-3/5 bg-gradient-to-br from-blue-600 via-blue-700 to-blue-800 relative overflow-hidden flex items-center justify-center">
